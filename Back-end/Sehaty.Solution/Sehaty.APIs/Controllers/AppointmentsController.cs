namespace Sehaty.APIs.Controllers
{
    ...
    public class AppointmentsController(IUnitOfWork unit, IMapper mapper, IEmailSender emailSender, ISmsSender smsSender, IWebHostEnvironment env) : ApiBaseController
    {
