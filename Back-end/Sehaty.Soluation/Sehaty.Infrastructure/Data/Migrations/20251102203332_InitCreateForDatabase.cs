...
{
    /// <inheritdoc />
    public partial class InitCreateForDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameLocal = table.Column<string>(type: "nvarchar(100)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayOfWeek = table.Column<string>(type: "nvarchar(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingDateTime = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    ConfirmationDateTime = table.Column<DateTime>(type: "datetime", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Appointments_Status_Valid", "[Status] IN ('Pending','Confirmed','In Progress','Completed','Canceled','No-Show','Emergency')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Billing_Amount_Positive", "[Amount] > 0");
                    table.CheckConstraint("CK_Billing_Status_Valid", "[Status] IN ('Pending','Paid','Overdue','Cancelled')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Billing_InvoiceNumber_Unique",
                table: "Billing",
